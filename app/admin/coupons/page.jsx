...
export default function AdminCoupons() {
    ...
    return (
        <div className="text-slate-500 mb-40">
            ...
            {/* Add Coupon */}
            <form onSubmit={(e) => { e.preventDefault(); toast.promise(handleAddCoupon(e), { loading: "Adding coupon...", success: "Coupon Added", error: (err) => err.message }) }} className="max-w-sm text-sm">
                            ...
                            {coupons.map((coupon, index) => (
                                <tr key={index} className="hover:bg-slate-50">
                                    ...
                                    <td className="py-3 px-4 text-slate-800">
                                        <Trash onClick={() => toast.promise(deleteCoupon(coupon.code), { loading: "Deleting coupon...", success: "Coupon Deleted", error: (err) => err.message })} className="w-5 h-5 text-red-500 hover:text-red-800 cursor-pointer" />
                                    </td>
                                </tr>
                            ))}
                        </tbody>
